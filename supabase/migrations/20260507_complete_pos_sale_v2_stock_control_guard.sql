-- ============================================================
-- FIX: complete_pos_sale_v2 respeta stock_control_enabled
-- Fecha: 2026-05-07
--
-- PROBLEMA:
--   En el paso de descuento de stock (paso 13), el RPC restaba en
--   product_stock aunque el producto tuviera stock_control_enabled = false.
--   Eso podía disparar chk_stock_non_negative con mensajes técnicos.
--
-- SOLUCIÓN:
--   Descontar stock SOLO cuando products.stock_control_enabled = true.
--   Se mantiene aislamiento por sede con school_id = p_school_id.
-- ============================================================
