-- HOTFIX: search_parents_v3 error 42804
-- "Returned type timestamp without time zone does not match expected type timestamptz"
-- Solución: castear created_at a timestamptz dentro de la CTE base.
