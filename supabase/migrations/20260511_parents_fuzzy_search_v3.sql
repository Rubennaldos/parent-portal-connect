-- ============================================================
-- search_parents_v3 — búsqueda global multicampo con JOIN students
-- ============================================================
-- Objetivo:
--   - Búsqueda global sobre parent_profiles + students.full_name
--   - normalize_search() en columnas y término (acentos/case-insensitive)
--   - Paginación server-side con total_count real
--   - Mantener school_id opcional (NULL = global)
-- ============================================================

CREATE EXTENSION IF NOT EXISTS pg_trgm;
CREATE EXTENSION IF NOT EXISTS unaccent;

-- Índices de apoyo para JOIN/filtro cruzado.
CREATE INDEX IF NOT EXISTS idx_students_parent_id
  ON public.students(parent_id);

CREATE INDEX IF NOT EXISTS idx_students_full_name_trgm_v3
  ON public.students
