-- ═══════════════════════════════════════════════════════════════════
-- FASE 2: FIX check_student_spending_limit
-- 
-- Agrega filtros para:
-- 1. Excluir transacciones anuladas (is_deleted = true)
-- 2. Excluir transacciones canceladas (payment_status = 'cancelled')
-- ═══════════════════════════════════════════════════════════════════
...
BEGIN
  ...
  -- Gasto diario (excluye almuerzos, anuladas y canceladas)
  ...
  -- Verificar cada tope (prioridad: diario > semanal > mensual)
...
SELECT '✅ RPC actualizada: excluye transacciones anuladas y canceladas' AS resultado;
