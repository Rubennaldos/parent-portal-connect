-- =====================================================================
-- Muralla de rol en calculate_range_totals (cierre ciego)
-- Complementa 20260710_cash_blind_close_authority.sql
-- =====================================================================

CREATE OR REPLACE FUNCTION public.calculate_range_totals(
  p_school_id  UUID,
  p_start_date DATE,
  p_end_date   DATE,
...
GRANT EXECUTE ON FUNCTION public.calculate_range_totals(UUID, DATE, DATE, UUID[]) TO authenticated;

SELECT '20260710_cash_blind_range_totals_wall OK' AS resultado;
