-- ============================================================
-- BLOQUE 1 — Hotfix tipos de retorno get_sales_report
-- ============================================================
-- Error observado:
-- "Returned type character varying(100) does not match expected type text"
-- en columna 5 (payment_ref).
--
-- Causa:
-- - sales_report_row.payment_ref está tipado como text.
-- - transactions.operation_number es varchar(100).
-- - PostgreSQL exige match exacto en RETURNS SETOF type compuesto.
--
-- Fix:
-- - Cast explícito a text en ticket_code y payment_ref.
-- ============================================================
