...
// ÔöÇÔöÇ Constantes de error ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
...
// ÔöÇÔöÇ Helpers de respuesta ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
...
// ÔöÇÔöÇ Normalizaci├│n ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
...
// ÔöÇÔöÇ Validaci├│n del body ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
...
function validateBody(
  ...
  if (!body || typeof body !== "object") {
    return { ok: false, response: jsonErr(ERR_TEACHER_INVALID_INPUT, "Payload inv├ílido.", 400) };
  }
  ...
  if (dniRaw.length !== 8) {
    return { ok: false, response: jsonErr(ERR_TEACHER_INVALID_INPUT, "El DNI debe tener exactamente 8 d├¡gitos.", 400) };
  }
  if (phoneRaw.length < 9 || phoneRaw.length > 11) {
    return { ok: false, response: jsonErr(ERR_TEACHER_INVALID_INPUT, "El tel├®fono debe tener entre 9 y 11 d├¡gitos.", 400) };
  }
  if (!school_id) {
...
// ÔöÇÔöÇ Servidor ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ

serve(async (req: Request) => {
  if (req.method === "OPTIONS") return new Response("ok", { headers: corsHeaders });
  if (req.method !== "POST") {
    return jsonErr(ERR_TEACHER_DATABASE, "M├®todo no permitido.", 405);
  }
  ...
  try {
    ...
    if (!authHeader || !authHeader.toLowerCase().startsWith("bearer ")) {
      return jsonErr(ERR_TEACHER_UNAUTHORIZED, "Token faltante o inv├ílido.", 401);
    }
    ...
    if (authError || !authData?.user?.id) {
      return jsonErr(
        ...
        `Sesi├│n inv├ílida: ${authError?.message ?? "Token no reconocido"}`,
        401,
      );
    }
    ...
    // 6) Restricci├│n de sede para gestor_unidad
    ...
    //    GoTrue asigna instance_id, identities y todo lo necesario ÔÇö sin SQL manual.
    ...
    if (createAuthError) {
      // DNI ya registrado ÔåÆ ghost email ya existe en Auth
      if (
    ...
    if (!teacherUserId) {
      return jsonErr(ERR_TEACHER_DATABASE, "Auth no retorn├│ un user_id v├ílido.", 500);
    }

    // 8) RPC at├│mico: profiles + teacher_profiles + audit_logs (solo public.*)
    ...
    if (rpcError) {
      // Si el RPC falla, eliminar el usuario Auth reci├®n creado para no dejar hu├®rfanos
