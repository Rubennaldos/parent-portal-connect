-- ============================================
-- FIX: POLÍTICAS RLS PARA PARENT_PROFILES (LIMPIEZA TOTAL)
-- Eliminar TODAS las políticas y recrearlas
-- ============================================
...
DECLARE
    r RECORD;
BEGIN
    FOR r IN (SELECT policyname FROM pg_policies WHERE tablename = 'parent_profiles' AND schemaname = 'public') 
    LOOP
        EXECUTE format('DROP POLICY IF EXISTS %I ON parent_profiles', r.policyname);
    END LOOP;
END $$;
